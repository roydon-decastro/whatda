        ...
        <div className="relative flex items-end px-4 pb-10 pt-60 sm:px-6 sm:pb-16 md:justify-center lg:px-8 lg:pb-24">
          <div className="absolute inset-0">
            <img
              ...
              src="https://images.unsplash.com/photo-1625283518288-00362afc8663?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=685&q=80"
              alt=""
            />
          </div>
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            ...
            <p className="mt-2 text-base text-gray-600 dark:text-gray-300">
              ...
              <Link to="/login">
                <button className=" ml-2 font-medium text-indigo-600 transition-all duration-200 hover:text-indigo-700 hover:underline focus:text-indigo-700">
                  Sign In
                </button>
              </Link>
            </p>
            ...
            <form action="#" method="POST" className="mt-8">
              <div className="space-y-5">
                ...
                <div>
                  {err && (
                    <div className="my-4 rounded-lg text-center p-2 bg-red-500 text-white">
                      {err}
                    </div>
                  )}
                  <button
